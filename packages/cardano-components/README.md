...
Note: currently the build pipeline is messing up the the wasm files generated by @emurgo/cardano-serialization-library-browser. This will be fixed in an upcomming patch, but currently the npm package does not work.
